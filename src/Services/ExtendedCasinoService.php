    ...
    private function initializeExtendedCasinos()
    {
        $this->casinos = [
            ...
            [
                'id' => 2,
                'name' => 'NOVAJACKPOT',
                'logo_url' => '/assets/logos/novajackpot-logo.svg',
                'rating' => 4.3,
                ...
                'game_count' => 3500,
                'welcome_bonus' => [
                    'type' => 'Multi-Deposit Bonus',
                    'amount' => '€1000',
                    'percentage' => 100,
                    'details' => 'Up to €1000 + 275 Free Spins'
                ],
                'security_certifications' => ['Curaçao Gaming License #8048/JAZ2020-013', 'SSL Encryption', 'Responsible Gambling Tools'],
                'payment_methods' => ['Bitcoin', 'Ethereum', 'Visa', 'Mastercard', 'Skrill', 'Neteller', 'Interac'],
                'software_providers' => ['Pragmatic Play', 'NetEnt', 'Play\'n GO', 'Evolution Gaming', 'Microgaming'],
                'mobile_compatibility' => true,
                'live_chat_support' => true,
                'trust_score' => 93,
                'canadian_friendly' => true,
                ...
                'license_info' => 'Curaçao Gaming License #8048/JAZ2020-013',
                'operator' => 'Hollycorn N.V.',
                'vip_program' => '5-tier loyalty system',
                'withdrawal_limits' => ['daily' => '€5,000', 'monthly' => '€25,000'],
                'processing_time' => ['ewallets' => '0-24h', 'cards' => '1-3 days'],
                'featured_badge' => 'Multi-Jurisdiction',
                'special_features' => ['Crypto Payments', '21 Countries', '3,500+ Games', 'VIP Program']
            ],
            [
                'id' => 3,
                'name' => 'Ruby Fortune',
